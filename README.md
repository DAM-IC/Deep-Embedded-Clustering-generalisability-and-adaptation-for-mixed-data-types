...
- The DEC functionality is based on the work of Xie et al., 2015 (https://github.com/piiswrong/dec).
- The XVAE functionality is based on the work of Simidjievski et al., 2019 (https://github.com/CancerAI-CL/IntegrativeVAEs)
